...
export function DSRNDPSEntryForm({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-bold text-foreground mb-4">Accused Details</h3>
        ...
        <>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <button onClick={() => setCourtDecision("bail")} className={`flex-1 py-2.5 rounded-lg text-sm font-semibold transition-colors ${courtDecision === "bail" ? "text-white" : "border hover:bg-muted"}`} style={courtDecision === "bail" ? { background: "hsl(var(--destructive))" } : { borderColor: "hsl(var(--border))" }}>Court Decision: Bail</button>
            </div>
          </div>
