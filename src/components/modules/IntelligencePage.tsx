...
const topTabs = ["Source Reports", "Accused Profiles", "Approval Workflow"];
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 pt-5 pb-0">
        ...
        >
          <Plus className="h-4 w-4" /> New Source Report
        </button>
      </div>
              ...
              <div key={report.id} className="stat-card">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">{report.id} · {report.source} · {report.date}</p>
                  </div>
                  ...
                  {workflowSteps.map((step, i) => (
                    <div key={step.role} className="flex items-center gap-1 shrink-0">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <p className="text-[10px] text-center font-medium w-16" style={{ color: "hsl(var(--muted-foreground))" }}>{step.role}</p>
