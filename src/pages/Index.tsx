...
import { CheckpostPage, AuditLogsPage } from "@/components/modules/CheckpostPage";
  ...
  settings: () => (
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm" style={{ color: "hsl(var(--muted-foreground))" }}>System configuration coming soon</p>
      </div>
    </div>
  ),
};
